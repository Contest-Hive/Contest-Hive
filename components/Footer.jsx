        ...
        <span className="mt-4 inline-flex justify-center sm:ml-auto sm:mt-0 sm:justify-start">
          ...
          >
            <svg
              ...
              strokeWidth="2"
              className="h-7 w-7 transition  duration-300 hover:-rotate-[373deg]"
              viewBox="0 0 24 24"
            >
          ...
          >
            <svg
              ...
              strokeLinejoin="round"
              strokeWidth="2"
              className="h-7 w-7 transition  duration-300 hover:rotate-[330deg]  "
              viewBox="0 0 24 24"
            >
          ...
          >
            <svg
              ...
              strokeLinejoin="round"
              strokeWidth="0"
              className="h-7 w-7 transition  duration-300 hover:-rotate-[370deg]"
              viewBox="0 0 24 24"
            >
              <path
                stroke="none"
