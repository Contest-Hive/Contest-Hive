...
const StarInGithub = () => {
  ...
  return (
    // <section className="mx-auto w-11/12 max-w-screen-md text-center md:w-2/3 mt-20" data-aos="fade-up">
    ...
    //   </p>
    <div className="mx-auto mb-32 flex w-fit justify-center text-gray-700 hover:text-sky-500">
      {/* 90deg */}
