  ...
  return (
    <div className="container mx-auto flex flex-wrap px-5 py-24">
      <div className="flex w-full flex-col text-center">
        <h1 className="title-font text-5xl font-bold text-white sm:text-6xl">
          Contest Hive
        </h1>
        ...
        <div className="mt-16 flex justify-center">
          ...
          <Link href={GithubUrl} target="_blank">
            <button className="ml-4 inline-flex  rounded border-0 bg-gray-800 px-8 py-2 text-lg transition duration-500 hover:bg-indigo-800 hover:text-white focus:outline-none">
              Github
              <span>
                <svg
                  viewBox="0 0 16 16"
          ...
          <div className="md:h-70 absolute -inset-0.5 -z-10 mx-auto mt-60 h-52 w-52 rounded-lg bg-gradient-to-r from-indigo-800 to-fuchsia-800 opacity-40 blur-3xl md:w-96 md:opacity-30"></div>
        </div>
      </div>
    </div>
  );
