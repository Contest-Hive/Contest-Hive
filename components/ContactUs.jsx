    ...
    <>
      ...
      >
        ...
        {loading && (
          <svg
            aria-hidden="true"
            className="mb-1 ml-5 inline-block h-6 w-6 animate-spin fill-gray-400 text-gray-600"
            viewBox="0 0 100 101"
            fill="none"
        ...
        {successSvg && (
          <svg
            className="mb-1 ml-5 inline-block h-6 w-6 animate-bounce text-green-500"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 20 20"
